...
double gaus2(x,z,fxr,fzr,h,vi,vj,kk,n,js,ss,f)
int vi,vj,n,js[];
...
double gaus4(fxr,fzr,h,vi,vj,vi1,vj1,kk,n,js,ss,f)
...
double fre2(int n,double x,double z,double kk,double var[])
{
	...
	if(r==0.0)
	{
           func=2*PI*0.00001*0.00001*Greenr(kk*0.00001);
        }else
        {
           func=Greenr(r);
        }
...
double fim2(int n,double x,double z,double kk,double var[])
{
	...
	if(r==0.0)
	{
           func=2*PI*0.00001*0.00001*Greeni(kk*0.00001);
        }else
        {
           func=Greeni(r);
        }
